import { PortfolioContent } from '@/lib/ai/content-generator';
...
export function generatePortfolioHTML(props: PortfolioTemplateProps): string {
  const { data, cvUrl, profilePictureUrl, githubProfile } = props;
  
  // Generate the HTML string with replaced placeholders
  return `<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="${data.fullName}'s professional portfolio showcasing skills and projects in ${data.title}">
</head>
<body>
    ...
    <section id="projects" class="projects">
        <div class="container">
            <div class="section-header">
                <h2>Projects
                    ${githubProfile ? `
                    <a href="${githubProfile}" class="github-link" target="_blank" title="Visit my GitHub profile">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="${project.imageUrl || 'https://placehold.co/600x400/e2e8f0/1e293b?text=Project+Image'}" alt="${project.name}" class="project-img" onerror="this.src='https://placehold.co/600x400/e2e8f0/1e293b?text=Project+Image'">
                    </div>
                    <div class="project-info">
                        ...
                        <div class="project-links">
                            ${project.githubUrl ? `
                            <a href="${project.githubUrl}" class="project-link github" target="_blank">
                                <i class="fab fa-github"></i> GitHub
                            </a>
                            ` : ''}
                            ${project.reportUrl ? `
                            <a href="${project.reportUrl}" class="project-link report" target="_blank">
...
function getScript(title: string): string {
  return `
    ...
    // Typing effect
    const titles = ['${title}', 'Problem Solver', 'Creative Thinker'];
    let titleIndex = 0;
    let charIndex = 0;
